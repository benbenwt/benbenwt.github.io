...
```
服务器没了之后，如何搭建自己的平台。向外展示的服务：es，mysql，clickhouse，superset，springboot，echarts，可以把这些零散的服务做成一个docker-compose，方便展示
集群和项目的服务是在服务器上，只是将清洗结果和可视化服务迁移到本机。
实验室没有其他项目嘛，有一些小项目，与当前职位关系很小。
```
